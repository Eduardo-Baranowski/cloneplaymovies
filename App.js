    ...
    return(
      <View>
        <TouchableOpacity>
          ...
          <Icon 
          name='play-circle-outline' sizer={30} color="#fff" style={styles.carouselIcon} />
        </TouchableOpacity>
      </View>
    );
  };
          ...
          >
            <View style={styles.viewSearch}>
              ...
              <TouchableOpacity style={styles.icon}>
                <Icon name="search" color="#000" sizer={25} />
              </TouchableOpacity>
            </View>

            <Text 
            style={{color:'#fff', fontSize:25, fontWeight:'bold', marginVertical:10,
            ...
            <View style={styles.moreInfo}>
              ...
              <TouchableOpacity style={{marginRight:15, marginTop:10}} onPress={()=>alert('Assistir')}>
